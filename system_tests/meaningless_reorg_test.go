...
func TestMeaninglessBatchReorg(t *testing.T) {
	...
	tx, err := seqInbox.AddSequencerL2Batch56b96c89(&seqOpts, big.NewInt(1), nil, big.NewInt(1), common.Address{}, common.Big0, common.Big0, createDummyEspressoMetadata(t))
	Require(t, err)
