...
func TestMeaninglessBatchReorg(t *testing.T) {
	...
	tx, err := seqInbox.AddSequencerL2BatchFromOrigin37501551(&seqOpts, big.NewInt(1), nil, big.NewInt(1), common.Address{}, common.Big0, common.Big0, createDummyHotShotHeightAndSignature(t))
	Require(t, err)
	...
	tx, err = seqInbox.AddSequencerL2Batch99020501(&seqOpts, big.NewInt(1), nil, big.NewInt(1), common.Address{}, common.Big0, common.Big0, createDummyHotShotHeightAndSignature(t))
	Require(t, err)
