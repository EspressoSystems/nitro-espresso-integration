...
func TestEspressoStreamer(t *testing.T) {
	...
	t.Run("Test should pop messages in order", func(t *testing.T) {
		...
		streamer := NewEspressoStreamer(1, 1, mockEspressoTEEVerifierClient, mockEspressoClient, false, func(l1Height uint64) []common.Address {
			return []common.Address{common.HexToAddress("0x3918b6ecc471211a942B0A904fbFb36302348f6B")}
		}, 1*time.Second, 0)
		streamer.Reset(32053959, 1)
