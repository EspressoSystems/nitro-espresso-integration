...
func TestEspressoParsing(t *testing.T) {
	...
	var mockChainConfig = &espressoTypes.ResolvableChainConfig{
		ChainConfig: espressoTypes.EitherChainConfig{
			Left: &espressoTypes.ChainConfig{ChainId: *espressoTypes.NewU256().SetUint64(0x8a19).ToDecimal(), MaxBlockSize: 10240, BaseFee: *espressoTypes.NewU256().SetUint64(0).ToDecimal()},
		},
	}
