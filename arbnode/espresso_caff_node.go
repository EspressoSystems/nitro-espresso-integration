...
func EspressoCaffNodeConfigAddOptions(prefix string, f *flag.FlagSet) {
	...
	f.String(prefix+".attestation-service-url", DefaultEspressoCaffNodeConfig.AttestationServiceURL, "URL of the attestation service to use for obtaining zk proof over  attestation")
