...
func (s *TransactionStreamer) checkSubmittedTransactionForFinality(ctx context.Context) error {
	...
	for _, submittedTx := range submittedTxns {
		...
		data, err := s.checkEspressoQueryNodesForTransasction(ctx, submittedTxHash)
		if err != nil {
...
func (s *TransactionStreamer) checkEspressoQueryNodesForTransasction(ctx context.Context, hash *tagged_base64.TaggedBase64) (espressoTypes.TransactionQueryData, error) {
