...
require (
	...
	github.com/distributed-lab/enclave-extras v0.1.2 // indirect
	github.com/distributed-lab/enclave-extras/attestation v0.2.0 // indirect
	github.com/distributed-lab/enclave-extras/attestedkms v0.1.1 // indirect
